...
namespace Scripts.State
{
    public class GameState : IGameStateData
    {
        ...
        public static GameState Create(CardsState cards, HandState hand, PlayerState player, EnemyState enemy, GamePhaseState phase, SpellState spell, StatusEffectsState statusEffects)
        {
            return new GameState(cards, hand, player, enemy, phase, spell, statusEffects);
        }
        ...
        public IGameStateData WithCards(CardsState newCardsState)
        {
            ...
            return new GameState(newCardsState, Hand, Player, Enemy, Phase, Spell, StatusEffects);
        }
        ...
        public IGameStateData WithHand(HandState newHandState)
        {
            ...
            return new GameState(Cards, newHandState, Player, Enemy, Phase, Spell, StatusEffects);
        }
        ...
        public IGameStateData WithPlayer(PlayerState newPlayerState)
        {
            ...
            return new GameState(Cards, Hand, newPlayerState, Enemy, Phase, Spell, StatusEffects);
        }

        public IGameStateData WithEnemy(EnemyState newEnemyState)
        {
            if (newEnemyState == null) throw new ArgumentNullException(nameof(newEnemyState));
            return new GameState(Cards, Hand, Player, newEnemyState, Phase, Spell, StatusEffects);
        }
        ...
        public IGameStateData WithPhase(GamePhaseState newPhaseState)
        {
            ...
            return new GameState(Cards, Hand, Player, Enemy, newPhaseState, Spell, StatusEffects);
        }
        ...
        public IGameStateData WithSpell(SpellState newSpellState)
        {
            ...
            return new GameState(Cards, Hand, Player, Enemy, Phase, newSpellState, StatusEffects);
        }
        ...
        public IGameStateData WithStatusEffects(StatusEffectsState newStatusEffectsState)
        {
            ...
            return new GameState(Cards, Hand, Player, Enemy, Phase, Spell, newStatusEffectsState);
        }
        ...
        {
            return new GameState(Cards, Hand, Player, Enemy, Phase, Spell, StatusEffects, StateId, CreatedAt);
        }
